...
impl Keyword {
    ...
    pub fn all_keywords() -> impl Iterator<Item = Keyword> {
        Self::all_variants().into_iter().filter(|k| *k != Keyword::Undefined)
    }

    /// Return all enum variants as a slice-like vec.
    fn all_variants() -> Vec<Keyword> {
        vec![
            Keyword::Undefined, Keyword::Absorb, Keyword::Adapt, Keyword::Affinity,
            Keyword::Afflict, Keyword::Afterlife, Keyword::Aftermath, Keyword::Amplify,
            Keyword::Annihilator, Keyword::Ascend, Keyword::Assist, Keyword::AuraSwap,
            Keyword::Awaken, Keyword::Backup, Keyword::Banding, Keyword::BandsWith,
            Keyword::Bargain, Keyword::BattleCry, Keyword::Bestow, Keyword::Blitz,
            Keyword::Bloodthirst, Keyword::Bushido, Keyword::Buyback, Keyword::Cascade,
            Keyword::Casualty, Keyword::Champion, Keyword::Changeling, Keyword::ChooseABackground,
            Keyword::Cipher, Keyword::Companion, Keyword::Compleated, Keyword::Conspire,
            Keyword::Convoke, Keyword::Craft, Keyword::Crew, Keyword::CumulativeUpkeep,
            Keyword::Cycling, Keyword::Dash, Keyword::Daybound, Keyword::Deathtouch,
            Keyword::Decayed, Keyword::Defender, Keyword::Delve, Keyword::Demonstrate,
            Keyword::Dethrone, Keyword::Devour, Keyword::Devoid, Keyword::Disguise,
            Keyword::Disturb, Keyword::DoctorsCompanion, Keyword::DoubleAgenda,
            Keyword::DoubleStrike, Keyword::DoubleTeam, Keyword::Dredge, Keyword::Echo,
            Keyword::Embalm, Keyword::Emerge, Keyword::Enchant, Keyword::Encore,
            Keyword::Enlist, Keyword::Entwine, Keyword::Epic, Keyword::Equip,
            Keyword::Escape, Keyword::Escalate, Keyword::Eternalize, Keyword::Evoke,
            Keyword::Evolve, Keyword::Exalted, Keyword::Exploit, Keyword::Extort,
            Keyword::Fabricate, Keyword::Fading, Keyword::Fear, Keyword::Firebending,
            Keyword::FirstStrike, Keyword::Flanking, Keyword::Flash, Keyword::Flashback,
            Keyword::Flying, Keyword::ForMirrodin, Keyword::Foretell, Keyword::Fortify,
            Keyword::Freerunning, Keyword::Frenzy, Keyword::Fuse, Keyword::Gift,
            Keyword::Graft, Keyword::Gravestorm, Keyword::Harmonize, Keyword::Haste,
            Keyword::Haunt, Keyword::Hexproof, Keyword::Hideaway, Keyword::HiddenAgenda,
            Keyword::Horsemanship, Keyword::Impending, Keyword::Improvise,
            Keyword::Indestructible, Keyword::Infect, Keyword::Ingest, Keyword::Intimidate,
            Keyword::Kicker, Keyword::JobSelect, Keyword::JumpStart, Keyword::Landwalk,
            Keyword::LevelUp, Keyword::Lifelink, Keyword::LivingMetal, Keyword::LivingWeapon,
            Keyword::Madness, Keyword::Mayhem, Keyword::Melee, Keyword::Mentor,
            Keyword::Menace, Keyword::Megamorph, Keyword::Miracle, Keyword::Mobilize,
            Keyword::Monstrosity, Keyword::Modular, Keyword::MoreThanMeetsTheEye,
            Keyword::Morph, Keyword::Multikicker, Keyword::Mutate, Keyword::Myriad,
            Keyword::Nightbound, Keyword::Ninjutsu, Keyword::Outlast, Keyword::Offering,
            Keyword::Offspring, Keyword::Overload, Keyword::Partner, Keyword::PartnerWith,
            Keyword::Persist, Keyword::Phasing, Keyword::Plot, Keyword::Poisonous,
            Keyword::Protection, Keyword::Prototype, Keyword::Provoke, Keyword::Prowess,
            Keyword::Prowl, Keyword::Rampage, Keyword::Ravenous, Keyword::Reach,
            Keyword::ReadAhead, Keyword::Rebound, Keyword::Recover, Keyword::Reconfigure,
            Keyword::Reflect, Keyword::Reinforce, Keyword::Renown, Keyword::Replicate,
            Keyword::Retrace, Keyword::Riot, Keyword::Ripple, Keyword::Saddle,
            Keyword::Scavenge, Keyword::Shadow, Keyword::Shroud, Keyword::Skulk,
            Keyword::Sneak, Keyword::Soulbond, Keyword::Soulshift, Keyword::SpaceSculptor,
            Keyword::Specialize, Keyword::Spectacle, Keyword::Splice, Keyword::SplitSecond,
            Keyword::Spree, Keyword::Squad, Keyword::StartYourEngines,
            Keyword::StartingIntensity, Keyword::Station, Keyword::Storm, Keyword::Strive,
            Keyword::Sunburst, Keyword::Surge, Keyword::Suspend, Keyword::Tiered,
            Keyword::Toxic, Keyword::Training, Keyword::Trample, Keyword::Transfigure,
            Keyword::Transmute, Keyword::Tribute, Keyword::TypeCycling, Keyword::UmbraArmor,
            Keyword::Undaunted, Keyword::Undying, Keyword::Unearth, Keyword::Unleash,
            Keyword::Vanishing, Keyword::Vigilance, Keyword::Ward, Keyword::Warp,
            Keyword::WebSlinging, Keyword::Wither, Keyword::MayFlashCost, Keyword::MayFlashSac,
        ]
    }
}
